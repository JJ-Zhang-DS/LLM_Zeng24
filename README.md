...
| 4 | 2025-01-17 | Pipeline for LLM Applications: From Code to Products  <br> -full stack LLM: tools needed for an LLM application  -Case study: build an LLM app from ground  -Homework: Improve the chatbot from last week to make it an application that is ready to face real users |
